 ...
 *
 */
public class DumpWikipediaToDocIdPlainText extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(DumpWikipediaToDocIdPlainText.class);
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJarByClass(DumpWikipediaToDocIdPlainText.class);
    job.setJobName(String.format("DumpWikipediaToDocIdPlainText[%s: %s, %s: %s, %s: %s]", INPUT_OPTION,
  ...
  public DumpWikipediaToDocIdPlainText() {
  }

  public static void main(String[] args) throws Exception {
    ToolRunner.run(new DumpWikipediaToDocIdPlainText(), args);
  }
}
